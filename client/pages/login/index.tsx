  ...
  return (
    <div className='flex items-center justify-center min-w-full min-h-screen'>
        <form className='flex flex-col md:w-1/5'>
            ...
            <input 
                placeholder='email'
                className='p-3 mt-8 text rounded-md border-2 border-grey focus:outline-none focus:border-blue' 
                value={email}
           ...
           />
            <input 
                ...
                />
            <button className='p-3 mt-6 rounded-md bg-blue font-bold text-white'>Login</button>
        </form>
    </div>
  )
}
